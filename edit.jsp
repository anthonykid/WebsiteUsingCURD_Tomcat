...
<%
    Connection koneksi=DriverManager.getConnection("jdbc:mysql://localhost:3306/tabel_dosen_jsp","root","");
...
<body class="bg-primary text-light font-weight-bold">
        <header>
    ...
    <div class="container">
        ...
        <form method="post" action="update.jsp">
            ...
            <button type="reset" class="btn btn-danger"><i class='fas fa-cut'></i> Reset</button>
        </form>
    </div>
    <hr>

    <div id="dashboard" style="padding-top:15px;padding-bottom:0px">
        <footer>
          <div class="footer text-center bg-dark">
            <div class="container">
              <div class="row">
                <div class="col">
                  <h1><p class="text-light">Mohon Mengisi Formulir Anda Dengan Lebih Teliti</p></h1>
                </div>
              </div>
            </div>
          </div>
